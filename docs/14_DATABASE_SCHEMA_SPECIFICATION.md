...
_This database schema specification forms the definitive persistence standard for Craftor. All upcoming monorepo scaffolding, Prisma schemas, and WordPress plugin migration classes will implement these exact table structures._
